...
打开 [GitHub 官网](https://github.com)（无法访问可使用镜像站 [gh.2x.nz](https://gh.2x.nz)）
...
![](img/Pasted%20image%2020260426120753.png)
...
速度极快。就便捷性而言，Vercel 方案的综合体验甚至不如此方案。
